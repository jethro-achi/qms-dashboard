...
const METRICS: { term: string; desc: string }[] = [
  ...
  { term: "% of Customers Served Within SLA", desc: "The percentage of customers served within the Service Level Agreement (SLA) timeframe. The SLA defines the maximum acceptable wait time, which is 5 minutes. A higher percentage indicates better staff performance." },
  { term: "% of Customers Served Outside SLA", desc: "The percentage of customers who experienced service delays beyond the SLA timeframe. A lower percentage is desirable." },
...
const HOWTO: HowToGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { task: "Tune SLA & exception thresholds", steps: "In Settings → Metrics & Thresholds, set the SLA target and the exception threshold (minutes). Save thresholds and the dashboards recalculate automatically." },
    ],
  },
]
