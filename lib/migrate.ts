...
// for them.
//
// Migrations here (v2 — scheduled-report timing + recipients/sharing):
...
// Timing columns to add to app_report_schedules, with their per-dialect types.
const TIMING_COLUMNS: { name: string; mysql: string; mssql: string }[] = [
